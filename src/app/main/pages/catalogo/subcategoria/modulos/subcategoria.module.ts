...
import { RUTA_SUBCATEGORIA } from '../rutas/subcategoria-routing';
import { FormSubcategoriaComponent } from '../componentes/subcategoria-principal/form-subcategoria/form-subcategoria.component';

@NgModule({
  declarations: [
    SubcategoriaPrincipalComponent,
  ...
  imports: [
    CommonModule,
    RouterModule.forChild(RUTA_SUBCATEGORIA),
    CoreCommonModule,
    ContentHeaderModule,
    NgxPaginationModule,
    MaterialModule,
