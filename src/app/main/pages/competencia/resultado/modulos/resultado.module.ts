...
import { RUTA_RESULTADO } from '../rutas/resultado-routing';
import { ResultadoPrincipalComponent } from '../componentes/resultado-principal/resultado-principal.component';
import { FormResultadoComponent } from '../componentes/resultado-principal/form-resultado/form-resultado.component';
...
@NgModule({
  ...
  imports: [
    CommonModule,
    RouterModule.forChild(RUTA_RESULTADO),
    CoreCommonModule,
    ContentHeaderModule,
    NgxPaginationModule,
    MaterialModule,
